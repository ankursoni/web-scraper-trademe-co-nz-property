...
class TestPropertySearch:
    ...
    def mock_property_search_001_requests_get(url):
        ...
        response = type('requests.models.Response', (object,),
    ...
    def test_property_search_001_fetch(self, mocker):
        # arrange
        mocker.patch.object(search.main, 'DEFAULT_HIT_DELAY_SECONDS',
        ...
        assert result[0].link == 'https://www.trademe.co.nz/a/property/residential/sale/auckland/rodney/gulf-harbour/listing/3640441947'
        ...
        assert result[-1].link == 'https://www.trademe.co.nz/a/property/residential/sale/auckland/rodney/gulf-harbour/listing/3611361622'
    ...
    def test_propertydetail_001_fetch(self, mocker):
        ...
        result = search.main.property_detail_fetch(
            ...
            property_search=TestPropertySearch.property_search_result[19] if TestPropertySearch.property_search_result else None)
        ...
        assert result.link == 'https://www.trademe.co.nz/a/property/residential/sale/auckland/manukau-city/the-gardens/listing/3615355083'
        ...
        assert result.in_the_area == 'Schools: Primary / Intermediate School: The Gardens School. Secondary School: Alfriston College'
        ...
        assert result.description == '''Finding the right home can be a challenge, especially a home which can satisfy all members of the family. This treasured home in The Gardens could be the one for you! 
...
'''
    ...
    def test_propertydetail_002_fetch(self, mocker):
        ...
        result = search.main.property_detail_fetch(
            ...
            property_search=TestPropertySearch.property_search_result[21] if TestPropertySearch.property_search_result else None)
        ...
        assert result.city == 'auckland'
        assert result.link == 'https://www.trademe.co.nz/a/property/residential/sale/auckland/rodney/gulf-harbour/listing/3611361622'
        ...
        assert result.broadband_options == 'Fibre, ADSL, VDSL, Wireless'
        assert result.description == '''Situated in one of Gulf Harbour's premier locations this desirable address and executive residence is a winning combination. Designed for family and entertaining this heartwarming home is a show stopper with 5 bedrooms, 3 bathrooms, 2 living and inground pool, not to mention the triple car garaging.
...
'''
    ...
    def test_propertydetail_003_fetch(self, mocker):
        ...
        result = search.main.property_detail_fetch(
            ...
            property_search=TestPropertySearch.property_search_result[18] if TestPropertySearch.property_search_result else None)
        ...
        assert result.city == 'auckland'
        assert result.link == 'https://www.trademe.co.nz/a/property/new-homes/house-land/auckland/rodney/milldale/listing/3615362032'
        ...
        assert result.description == '''Our home at 18 Ruxton Road (off end of Argent Lane) is available for viewing, if you would like to see an example of a finished home
